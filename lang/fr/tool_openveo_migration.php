...
$string['settingsmigrateduservideonameformat_help'] = 'Le format à utiliser pour le nom des vidéos issues d\'un contexte utilisateurs sur OpenVeo. Les jetons disponibles sont : <ul><li><strong>%filename%</strong>: Le nom du fichier vidéo</li><li><strong>%userid%</strong> : L\'identifiant de l\'utilisateur</li><li><strong>%username%</strong> : Le nom de l\'utilisateur</li><li><strong>%userfirstname%</strong> : Le prénom de l\'utilisateur</li><li><strong>%userlastname%</strong> : Le nom de famille de l\'utilisateur</li><li><strong>%useremail%</strong> : L\'email de l\'utilisateur</li></ul> ("%userid% - %filename%" par défaut)';
