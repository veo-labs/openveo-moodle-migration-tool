...
/**
 * Defines an event warning about an error when removing an OpenVeo video.
 *
...
/**
 * Defines the event triggered if removing an OpenVeo video failed.
 *
 * @package tool_openveo_migration
 * @copyright 2018 Veo-labs
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class removing_openveo_video_failed extends base {
    ...
    public static function get_name() : string {
        return get_string('eventremovingopenveovideofailed', 'tool_openveo_migration');
    }
