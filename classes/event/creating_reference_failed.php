...
/**
 * Defines an event warning about an error when creating a video reference.
 *
 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class creating_reference_failed extends base {
    ...
    public static function get_name() : string {
        return get_string('eventcreatingreferencefailed', 'tool_openveo_migration');
    }
