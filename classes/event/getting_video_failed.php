...
/**
 * Defines an event warning about an error when trying to get a Moodle video file.
 *
...
/**
 * Defines the event triggered if getting a Moodle video file failed.
 *
 * @package tool_openveo_migration
 * @copyright 2018 Veo-labs
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class getting_video_failed extends base {
    ...
    public static function get_name() : string {
        return get_string('eventgettingvideofailed', 'tool_openveo_migration');
    }
